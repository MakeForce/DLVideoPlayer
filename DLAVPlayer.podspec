Pod::Spec.new do |s|
  ...
  # ―――  Spec Metadata  ―――――――――――――――――――――――――――――――――――――――――――――――――――――――――― #
  s.name         = "DLVideoPlayer"
  s.version      = "0.0.1"
  s.summary      = "custom player"

  s.description  = <<-DESC
                   Use AVFoundation's AVPlayer;
  ...
  s.homepage     = "https://github.com/yin329039646/DLVideoPlayer"
  ...
  # ――― Source Location ―――――――――――――――――――――――――――――――――――――――――――――――――――――――――― #
  s.source       = { :git => "https://github.com/yin329039646/DLVideoPlayer.git", :tag => "0.0.1" }
